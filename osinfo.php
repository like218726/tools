...
var OutSpeed2 = <?php echo floor($S->NetWork['OutSpeed'][2]);?>;
var OutSpeed3 = <?php echo floor($S->NetWork['OutSpeed'][3]);?>;
var OutSpeed4 = <?php echo floor($S->NetWork['OutSpeed'][4]);?>;
var OutSpeed5 = <?php echo floor($S->NetWork['OutSpeed'][5]);?>;
var InputSpeed2 = <?php echo floor($S->NetWork['InputSpeed'][2]);?>;
var InputSpeed3 = <?php echo floor($S->NetWork['InputSpeed'][3]);?>;
var InputSpeed4 = <?php echo floor($S->NetWork['InputSpeed'][4]);?>;
var InputSpeed5 = <?php echo floor($S->NetWork['InputSpeed'][5]);?>;
...
<div id="page">
    ...
    <div class="con">
        ...
        <div class="j_tb">
	        <label class="j_td j_td_t">服务器域名/IP地址</label>
	        <label><?php echo $S->S['DomainIP'];?></label>
        </div>
        <div class="j_tb">
	        <labelclass="j_td j_td_t">服务器标识</label>
	        <label><?php echo $S->S['Flag'];?></label>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t">服务器操作系统</label>
	            <label class="j_td"><?php echo $S->S['OS'];?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t">服务器解译引擎</label>
	            <label class="j_td"><?php echo $S->S['WebEngine'];?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t">服务器语言</label>
	            <label class="j_td"><?php echo $S->S['Language'];?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t">服务器端口</label>
	            <label class="j_td"><?php echo $S->S['WebPort'];?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t">服务器主机名</label>
	            <label class="j_td"><?php echo $S->S['Name'];?></label>
            </div>
            <div class="j_td"s tyle="width: 50%">
	            <label class="j_td j_td_t">绝对路径</label><label class="j_td">
	            <?php echo $S->S['WebPath'];?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t">管理员邮箱</label>
	            <label class="j_td"><?php echo $S->S['Email'];?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t">探针路径</label>
	            <label class="j_td"><?php echo $S->S['ProbePath'];?></label>
            </div>
        </div>
    </div>
    <!--Server Real-Time-->
    <div class="con">
        ...
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            ...
	            <label class="j_td"id="stime"><?php echo $S->S['sTime'];?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t">服务器已运行时间</label>
	            <label class="j_td"id="uptime"><?php echo $S->sysInfo['uptime'];?></label>
            </div>
        </div>
        <div class="j_tb">
	        <label class="j_td j_td_t">CPU型号[<?php echo $S->sysInfo['cpu']['num'];?>核]</label>
	        <label><?php echo $S->sysInfo['cpu']['model'];?></label>
        </div>
        <div class="j_tb">
	        <label class="j_td j_td_t">CPU使用情况</label>
	        <label id="cpuuse"><?php echo $S->CPU_Use;?></label>
        </div>
        <div class="j_tb">
        	<label class="j_td j_td_t">硬盘使用状况</label>
            <label>
            	 总空间 <?php echo $S->hd['t'];?>&nbsp;G，
            	 已用 <font color='#333333'><span id="useSpace"><?php echo $S->hd['u'];?></span></font>&nbsp;G，
                                     空闲 <font color='#333333'><span id="freeSpace"><?php echo $S->hd['f'];?></span></font>&nbsp;G，
               	 使用率 <span id="hdPercent"><?php echo $S->hd['PCT'];?></span>%
                <div class="bar">
                <div id="barhdPercent" class="barli_black"style="width:<?php echo $S->hd['PCT']?>%">&nbsp;</div> 
                </div>
            </label>
        </div>
        <div class="j_tb">
        	<label class="j_td j_td_t">内存使用状况</label>
            <label class="j_td">物理内存：
            	共<font color='#CC0000'><?php echo $S->sysInfo['memTotal'];?> </font>
                , 已用<font color='#CC0000'><span id="UsedMemory"><?php echo $S->sysInfo['memUsed']?></span></font>
                , 空闲<font color='#CC0000'><span id="FreeMemory"><?php echo $S->sysInfo['memFree'];?></span></font>
                , 使用率<span id="memPercent"><?php echo $S->sysInfo['memPercent'];?></span>
                <div class="bar">
                	<div id="barmemPercent"class="barli_red"style="width:<?php echo $S->sysInfo['memPercent'];?>%">&nbsp;</div>
                </div>
            <?php if($S->sysInfo['memCached']){?>
                Cache化内存为 <span id="CachedMemory"><?php echo $S->sysInfo['memCached'];?></span>
                , 使用率<span id="memCachedPercent"><?php echo $S->sysInfo['memCachedPercent'];?></span>% |
                Buffers缓冲为  <span id="Buffers"><?php echo $S->sysInfo['memBuffers'];?></span>
                <div class="bar">
                	<div id="barmemCachedPercent" class="barli_blue" style="width:<?php echo $S->sysInfo['memCachedPercent'];?>%">&nbsp;</div>
                </div>
                                   真实内存使用<span id="memRealUsed"><?php echo $S->sysInfo['memRealUsed'];?></span>
                , 真实内存空闲<span id="memRealFree"><?php echo $S->sysInfo['memRealFree'];?></span>
                , 使用率<span id="memRealPercent"><?php echo $S->sysInfo['memRealPercent'];?></span>%
                <div class="bar_1">
                	<div id="barmemRealPercent" class="barli_1" style="width:<?php echo $S->sysInfo['memRealPercent'];?>%">&nbsp;</div>
                </div>
            <?php }?>
            <?php if ($S->sysInfo['swapTotal']) {?>
                SWAP区：共<?php echo $S->sysInfo['swapTotal'];?>
                , 已使用<span id="swapUsed"><?php echo $S->sysInfo['swapUsed'];?></span>
                , 空闲<span id="swapFree"><?php echo $S->sysInfo['swapFree'];?></span>
                , 使用率<span id="swapPercent"><?php echo $S->sysInfo['swapPercent'];?></span>%
                <div class="bar">
                	<div id="barswapPercent" class="barli_red" style="width:<?php echo $S->sysInfo['swapPercent'];?>%">&nbsp;</div> 
                </div>
            <?php }?>
            </label>
        </div>
        <div class="j_tb">
	        <label class="j_td j_td_t">系统平均负载</label>
	        <label class="j_td"><?php echo $S->sysInfo['loadAvg']?></label>
        </div>
    </div>
    <!--net work-->
    <div class="con">
        ...
        <?php
            ...
            for($i=2;$i < $netnum;$i++) { ?>
                <div class="j_tb">
                    <label class="j_td"style="width:13%"><?php echo $S->NetWork['NetWorkName'][$i]?></label>
                    <label class="j_td"style="width:29%">
                    	入网：<font color='#CC0000'>
                    		<span id="NetInput<?php echo $i;?>"><?php echo $S->NetWork['NetInput'][$i];?></span>
                    	</font>
                    </label>
                    <label class="j_td"style="width:14%">
                    	实时：<font color='#CC0000'>
                    			<span id="NetInputSpeed<?php echo $i;?>">0B/s</span>
                    		</font>
                    </label>
                    <label class="j_td"style="width:29%">
                    	出网: <font color='#CC0000'>
                    			<span id="NetOut<?php echo $i?>"><?php echo $S->NetWork['NetOut'][$i];?></span>
                    		</font>
                    </label>
                    <label class="j_td"style="width:14%">
                    	实时: <font color='#CC0000'>
                    			<span id="NetOutSpeed<?php echo $i?>">0B/s</span>
                    		</font>
                    </label>
                </div>
        <?php }?>
    ...
    <div class="con">
        ...
        <div class="j_tb">
            <div class="j_td"style="width: 50%">
            	<label class="j_td j_td_t1">PHP信息（phpinfo）：</label>
            	<label class="j_td"><?php echo $disFuns;?></label>
            </div>
            <div class="j_td"style="width: 50%">
            	<label class="j_td j_td_t1">PHP版本（php_version）：</label>
            	<label class="j_td"><?php echo PHP_VERSION;?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td"style="width: 50%">
            	<label class="j_td j_td_t1">PHP运行方式：</label>
            	<label class="j_td"><?php echo strtoupper(php_sapi_name());?></label>
            </div>
            <div class="j_td"style="width: 50%">
            	<label class="j_td j_td_t1">脚本占用最大内存（memory_limit）：</label>
            	<label class="j_td"><?php echo $S::show("memory_limit");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">PHP安全模式（safe_mode）：</label>
	            <label class="j_td"><?php echo $S::show("safe_mode");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">POST方法提交最大限制（post_max_size）：</label>
	            <label class="j_td"><?php echo $S::show("post_max_size");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">上传文件最大限制（upload_max_filesize）：</label>
	            <label class="j_td"><?php echo $S::show("upload_max_filesize");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">浮点型数据显示的有效位数（precision）：</label>
	            <label class="j_td"><?php echo $S::show("precision");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">脚本超时时间（max_execution_time）：</label>
	            <label class="j_td"><?php echo $S::show("max_execution_time");?>秒</label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">socket超时时间（default_socket_timeout）：</label>
	            <label class="j_td"><?php echo $S::show("default_socket_timeout");?>秒</label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">PHP页面根目录（doc_root）：</label>
	            <label class="j_td"><?php echo $S::show("doc_root");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">用户根目录（user_dir）：</label>
	            <label class="j_td"><?php echo $S::show("user_dir");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">dl()函数（enable_dl）：</label>
	            <label class="j_td"><?php echo $S::show("enable_dl");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">指定包含文件目录（include_path）：</label>
	            <label class="j_td"><?php echo $S::show("include_path");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">显示错误信息（display_errors）：</label>
	            <label class="j_td"><?php echo $S::show("display_errors");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">自定义全局变量（register_globals）：</label>
	            <label class="j_td"><?php echo $S::show("register_globals");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">数据反斜杠转义（magic_quotes_gpc）：</label>
	            <label class="j_td"><?php echo $S::show("magic_quotes_gpc");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">"&lt;?...?&gt;"短标签（short_open_tag）：</label>
	            <label class="j_td"><?php echo $S::show("short_open_tag");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td"style="width: 50%">
            ...
            <div class="j_td"style="width: 50%">
	            ...
	            <label class="j_td"><?php echo $S::show("ignore_repeated_errors");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td"style="width: 50%">
	            <label class="j_td j_td_t1">忽略重复的错误源（ignore_repeated_source）：</label>
	            <label class="j_td"><?php echo $S::show("ignore_repeated_source");?></label></div>
            <div class="j_td"style="width: 50%">
	            <label class="j_td j_td_t1">报告内存泄漏（report_memleaks）：</label>
	            <label class="j_td"><?php echo $S::show("report_memleaks");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">自动字符串转义（magic_quotes_gpc）：</label>
	            <label class="j_td"><?php echo $S::show("magic_quotes_gpc");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">外部字符串自动转义（magic_quotes_runtime）：</label>
	            <label class="j_td"><?php echo $S::show("magic_quotes_runtime");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">打开远程文件（allow_url_fopen）：</label>
	            <label class="j_td"><?php echo $S::show("allow_url_fopen");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">声明argv和argc变量（register_argc_argv）：</label>
	            <label class="j_td"><?php echo $S::show("register_argc_argv");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">Cookie 支持：</label>
	            <label class="j_td"><?php echo $strcookies;?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">拼写检查（ASpell Library）：</label>
	            <label class="j_td"><?php echo$S::isfun("aspell_check_raw");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">高精度数学运算（BCMath）：</label>
	            <label class="j_td"><?php echo $S::isfun("bcadd");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">PREL相容语法（PCRE）：</label>
	            <label class="j_td"><?php echo $S::isfun("preg_match");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">PDF文档支持：</label>
	            <label class="j_td"><?php echo $S::isfun("pdf_close");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">SNMP网络管理协议：</label>
	            <label class="j_td"><?php echo $S::isfun("snmpget");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">VMailMgr邮件处理：</label>
	            <label class="j_td"><?php echo $S::isfun("vm_adduser");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">Curl支持：</label>
	            <label class="j_td"><?php echo $S::isfun("curl_init");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">SMTP支持：</label>
	            <label class="j_td"><?php echo $strsmtp;?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">SMTP地址：</label>
	            <label class="j_td"><?php echo $smtpadd;?></label>
            </div>
        </div>
        <div class="j_tb">
            <label class="j_td j_td_t1">默认支持函数（enable_functions）：</label>
            <label class="j_td"><a href='<?php echo $phpSelf;?>?act=Function'target='_blank' class='static'>请点这里查看详细！</a></label>
        </div>
        <div class="j_tb">
            <div class="j_td"style="width: 50%">
            	<label class="j_td j_td_t1">被禁用的函数（disable_functions）：</label>
            	<label class="j_td"><?php echo $S::GetDisFuns();?></label>
            </div>
        </div>
    </div>
    <!--组件支持-->
    ...
    <div class="con">
        ...
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">FTP支持：</label>
            	<label class="j_td"><?php echo $S::isfun("ftp_login");?></label>
            </div>
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">XML解析支持：</label>
            	<label class="j_td"><?php echo $S::isfun("xml_set_object");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">Session支持：</label>
	            <label class="j_td"><?php echo $S::isfun("session_start");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">Socket支持：</label>
	            <label class="j_td"><?php echo $S::isfun("socket_accept");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">Calendar支持</label>
            	<label class="j_td"><?php echo $S::isfun('cal_days_in_month');?></label>
            </div>
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">允许URL打开文件：</label>
            	<label class="j_td"><?php echo $S::show("allow_url_fopen");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">GD库支持：</label>
            	<label class="j_td"><?php echo $S::GetGDVer();?></label>
            </div>
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">压缩文件支持(Zlib)：</label>
            	<label class="j_td"><?php echo $S::isfun("gzclose");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">IMAP电子邮件系统函数库：</label>
            	<label class="j_td"><?php echo $S::isfun("imap_close");?></label>
            </div>
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">历法运算函数库：</label>
            	<label class="j_td"><?php echo $S::isfun("JDToGregorian");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">正则表达式函数库：</label>
            	<label class="j_td"><?php echo $S::isfun("preg_match");?></label>
            </div>
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">WDDX支持：</label>
            	<label class="j_td"><?php echo $S::isfun("wddx_add_vars");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">Iconv编码转换：</label>
            	<label class="j_td"><?php echo $S::isfun("iconv");?></label>
            </div>
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">mbstring：</label>
            	<label class="j_td"><?php echo $S::isfun("mb_eregi");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">高精度数学运算：</label>
            	<label class="j_td"><?php echo $S::isfun("bcadd");?></label>
            </div>
            <div class="j_td"style="width: 50%">
            	<label class="j_td j_td_t1">LDAP目录协议：</label>
            	<label class="j_td"><?php echo $S::isfun("ldap_close");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">MCrypt加密处理：</label>
            	<label class="j_td"><?php echo $S::isfun("mcrypt_cbc");?></label>
            </div>
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">哈稀计算：</label>
            	<label class="j_td"><?php echo $S::isfun("mhash_count");?></label>
            </div>
        </div>
    </div>
    ...
    <div class="con">
        ...
        <div class="j_tb"><?php echo $zendInfo= $S::GetZendInfo();?>
            ...
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1"><?php echo $zendInfo['loader']?></label>
	            <label class="j_td"><?php echo $zendInfo['html'];?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">eAccelerator</label>
	            <label class="j_td"><?php echo $S->CHKModule('eAccelerator');?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">ioncube</label>
	            <label class="j_td"><?php echo $S->GetIconcube();?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">XCache</label>
	            <label class="j_td"><?php echo $S->CHKModule('XCache');?></label>
            </div>
            <di vclass="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">APC</label>
	            <label class="j_td"><?php echo $S->CHKModule('APC');?></label>
            </div>
        </div>
    </div>
    <a name="w_db"></a>
    ...
    <div class="con">
        ...
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">MySQL 数据库：</label>
	            <label class="j_td"><?php echo $S::isfun('mysql_close').$S::GetDBVer('mysql');?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">ODBC 数据库：</label>
	            <label class="j_td"><?php echo $S::isfun("odbc_close");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">Oracle 数据库：</label>
        ...
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">dBASE 数据库：</label>
	            <label class="j_td"><?php echo $S::isfun("dbase_close");?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">mSQL 数据库：</label>
	            <label class="j_td"><?php echo $S::isfun("msql_close");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">SQLite 数据库：</label>
	            <label class="j_td"><?php echo $S->GetDBVer('sqlite');?></label>
            </div>
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">Hyperwave 数据库：</label>
	            <label class="j_td"><?php echo $S::isfun("hw_close");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
	            <label class="j_td j_td_t1">Postgre SQL 数据库：</label>
	            <label class="j_td"><?php echo $S::isfun("pg_close"); ?></label>
            </div>
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">Informix 数据库：</label>
            	<label class="j_td"><?php echo $S::isfun("ifx_close");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            ...
            <div class="j_td" style="width: 50%">
            	...
            	<label class="j_td"><?php echo $S::isfun("dbmclose");?></label>
            </div>
        </div>
        <div class="j_tb">
            <div class="j_td" style="width: 50%">
            	<label class="j_td j_td_t1">FilePro 数据库：</label>
            	<label class="j_td"><?php echo $S::isfun("filepro_fieldcount");?></label>
            </div>
            <div class="j_td"style="width: 50%">
            	<label class="j_td j_td_t1">SyBase 数据库：</label>
            	<label class="j_td"><?php echo $S::isfun("sybase_close");?></label>
            </div>
        </div>
    </div>
 
    <div class="con">
        <div align="center"><?php echo $run_time = sprintf('%0.4f', microtime_float() -$time_start);?>Processed in <?php echo $run_time?> seconds. <?php echo memory_usage();?> memory usage.</div>
    </div>
</div>
